      ...
      <div class="row">
        <div class="col-md-6" style="max-width: 100%; flex: 0 0 100%">
          <div class="card card-primary">
            ...
            <div class="card-body">
                <form action="{{route('admin.addkhachhangs')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="inputName" name="DienThoai" class="form-control" value="">
                    </div>
                    <div class="form-group">
                        <label for="inputDescription">Địa Chỉ</label>
                        <input type="text" id="inputName" name="DiaChi" class="form-control" value="">
                    </div>
                    <div class="form-group">
                        <label for="inputDescription">Email</label>
                        <input type="text" id="inputName" name="email" class="form-control" value="">
                    </div>
                    <div class="form-group">
                    ...
                    <input type="submit" value="Thêm mới khách hàng" class="btn btn-success float-right">
                </form>
            </div>
            <!-- /.card-body -->
          </div>
